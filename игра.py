...
def main(stdscr):
    ...
    while True:
        stdscr.clear()
        stdscr.addstr(0, 0, "Игра Студентская жизнь!!! Жанр Новелла.", curses.A_BOLD)
        stdscr.addstr(0, 10, "Глава 1", curses.A_BOLD)
        stdscr.addstr(2, 0, "Если хотите начать игру, нажмите 'y', если хотите закончить, нажмите 'q'", curses.A_NORMAL)
        stdscr.refresh()
        ...
        if key == ord('y'):
            stdscr.clear()
            stdscr.addstr(1, 50, "Игра началась! ", curses.A_BOLD)
            stdscr.refresh()
            time.sleep(2) 
            stdscr.clear()
                ...
                if key == ord('a'):
                    ...
                    while True:
                        ...
                        if key == ord('a'):
                            ...
                            stdscr.refresh()
                            time.sleep(3) 
                            stdscr.addstr(7, 20, "Вы ели-ели встаёте с дичайший перегаром, идете на кухню и выпиваете стакан воды с аспирином.", curses.A_BOLD)
                            stdscr.refresh()
                            time.sleep(3) 
                            ...
                            while True:
                                ...
                                if key == ord('a'):
                                    ...
                                    stdscr.refresh()
                                    time.sleep(3)
                                    stdscr.addstr(15, 20, "Вы закончили первый курс!!!", curses.A_BOLD)
                                    stdscr.refresh()
                                    time.sleep(3)
                                elif key == ord('s'):
                                    stdscr.clear() 
                                    ...
                                    while True:
                                        ...
                                        if key == ord('a'):
                                            ...
                                            stdscr.refresh()
                                            time.sleep(3)
                                            stdscr.addstr(5, 20, "Первый курс закончен!!!!!!", curses.A_BOLD)
                                            stdscr.refresh()
                                        elif key == ord('s'):
                                            stdscr.clear() 
                                            ...
                                            stdscr.refresh()
                                            time.sleep(3)
                                            stdscr.addstr(7, 20, "Для вас первый курс окончен. Поздравляю!!!", curses.A_BOLD)
                                            stdscr.refresh()
                                        elif key == ord('q'):
                                            return 
                                elif key == ord('q'):
                            ...
                            while True:
                                ...
                                if key == ord('a'):
                                    ...
                                    stdscr.refresh()
                                    time.sleep(3)
                                    stdscr.addstr(17, 20, "Вы успешно закончили первый курс, оставшись в хороших отношениях с другом!!!", curses.A_BOLD)
                                    stdscr.refresh()
                                    time.sleep(3)
                                elif key == ord('s'):
                                    stdscr.clear() 
                            ...
                            while True:
                                ...
                                if key == ord('a'):
                                    ...
                                    stdscr.refresh()
                                    time.sleep(3)
                                    stdscr.addstr(9, 20, "Поздравляю!!!", curses.A_BOLD)
                                    stdscr.refresh()
                                ...
                                if key == ord('s'):
                                    ...
                                    stdscr.refresh()
                                    time.sleep(3)
                                    stdscr.addstr(16, 20, "Поздравляю!!!", curses.A_BOLD)
                                    stdscr.refresh()
                elif key == ord('s'):
                    stdscr.clear()
                                ...
                                if key == ord('a'):
                                    ...
                                    while True:
                                        ...
                                        if key == ord('a'):
                                            ...
                                            stdscr.refresh()
                                            time.sleep(3)
                                            stdscr.addstr(16, 20, "Вы закончили первый курс!!!", curses.A_BOLD)
                                            stdscr.refresh()
                                        elif key == ord('s'):
                                            stdscr.clear() 
                                            ...
                                            stdscr.refresh()
                                            time.sleep(3)
                                            stdscr.addstr(24, 20, "Для вас первый курс окончен. Поздравляю!!!", curses.A_BOLD)
                                            stdscr.refresh()
                                        elif key == ord('q'):
                                            return 
                                elif key == ord('s'):
                                    ...
                                    stdscr.refresh()  
                                    time.sleep(3)  
                                    stdscr.addstr(17, 20, "Поздравляю!! Вы перешли на 2 курс. ", curses.A_BOLD)
                                    stdscr.refresh()  
                                ...
                                if key == ord('a'):
                                    ...
                                    while True:
                                        ...
                                        if key == ord('a'):
                                            ...
                                            stdscr.refresh()
                                            time.sleep(3)
                                            stdscr.addstr(8, 20, "Поздравляю!!!", curses.A_BOLD)
                                            stdscr.refresh()
                                    ...
                                    stdscr.refresh()
                                    time.sleep(3)
                                    stdscr.addstr(13, 20, "Поздравляю", curses.A_BOLD)
                                    stdscr.refresh()
                                    time.sleep(3)
                                elif key == ord('q'):
                                    return 
